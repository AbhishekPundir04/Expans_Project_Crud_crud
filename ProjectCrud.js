...
function addExpense(event) {
    ...
    axios.post("https://crudcrud.com/api/9739a2758b12454ea4b8c3b0dbbc02c4/addExpense", obj)
        .then((response) => {
...
window.addEventListener("DOMContentLoaded", () => {
    axios.get("https://crudcrud.com/api/9739a2758b12454ea4b8c3b0dbbc02c4/addExpense")
        .then((response) => {
            // console.log(response)
...
function deleteUser(userId) {
    axios.delete(`https://crudcrud.com/api/9739a2758b12454ea4b8c3b0dbbc02c4/addExpense/${userId}`)
        .then((response) => {
